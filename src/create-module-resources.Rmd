...
for (i in 1:length(modules)) {
  ...
  readLines(con=readings_filename)[-(1:6)] %>%
    paste0(collapse="\n") %>%
    paste0("<!--resources-readings-1-->\n", .) -> resources_readings[i]
