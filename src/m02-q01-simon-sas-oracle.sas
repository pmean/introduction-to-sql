...
Order all the fields by Pat_type_desc and print just the first four 
rows from the table.
...
ods pdf file="q:/introduction-to-sql/results/hw04-01-solution-using-sas-oracle-output.pdf";
