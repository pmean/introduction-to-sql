...
for (i in 1:length(modules)) {
  ...
  resources_homework_a <- ifelse(i==1, "\n<!--No homework answers-->\n", resources_homework_1[i-1])
  resources_homework_b <- ifelse(i==1, "\n<!--No homework answers-->\n", resources_homework_2[i-1])
  resources_intro %>% 
    paste0(resources_readings_1[i]) %>%
    paste0("\n\n") %>%
    paste0(resources_slides_1[i]) %>%
    paste0("\n\n") %>%
    paste0(resources_homework_a) %>%
    paste0("\n\n") %>%
    paste0(resources_conclusion[i]) %>%
    paste0("\n\n") %>%
    paste0(resources_readings_2[i]) %>%
    paste0("\n\n") %>%
    paste0(resources_slides_2[i]) %>%
    paste0("\n\n") %>%
    paste0(resources_homework_b) -> resources_text
